...
#define VAR_PECHARUNT_STATE                              0x4052 // Used to trigger Ogerpon Spawn in Pecharunt's Lair
...
#define VAR_MAUVILLE_CITY_STATE                          0x4059 // Used for new mauville sidequest, custom. 0-2 start new mauville, 3 end of mauville
...
#define VAR_DIFFICULTY_SWITCH_COUNTER                    0x407C // Used to check if player switch difficulty during playthru
#define VAR_DIFFICULTY                                   0x407D // For difficulty state, easy or normal (but listed as normal or hard for player)
...
#define VAR_CYNTHIA_STATE                                0x408B // Cynthia Battle
...
#define VAR_RAT_CAVE_STATE                               0x40A1  // 0-2 Luna battle, 3-4 Ratduardo first battle, 4-7 Rat Cave Fallarbor, 7-8 Lilycove, 8-12 Cresselia Ending, 8-14 Darkrai Ending
...
#define VAR_POSTGAME_REMATCH_COUNTER                     0x40DB // For final post game rematches
