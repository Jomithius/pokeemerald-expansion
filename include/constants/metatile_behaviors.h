...
#define MB_ULTRA_SPACE_TALL_GRASS 0x04
#define MB_SNOW_TALL_GRASS 0x05
...
#define MB_SAND_ENCOUNTER 0xF0
#define MB_REGION_MAP_NHOENN 0xF1

#define NUM_METATILE_BEHAVIORS 0xF2
