...
extern const u8 gText_BattleWhitneyName[];
extern const u8 gText_BattleDaveName[];
extern const u8 gText_BattleMomoName[];
extern const u8 gText_BattleAriaName[];
extern const u8 gText_BattleBennisName[];
