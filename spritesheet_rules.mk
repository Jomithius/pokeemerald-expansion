...
$(OBJEVENTGFXDIR)/people/ratduardo.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 2 -mheight 4

$(OBJEVENTGFXDIR)/people/misa.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 2 -mheight 4

$(OBJEVENTGFXDIR)/people/ceo.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 2 -mheight 4

$(OBJEVENTGFXDIR)/people/emo.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 2 -mheight 4	

$(OBJEVENTGFXDIR)/people/luna_f.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 2 -mheight 4

$(OBJEVENTGFXDIR)/people/biker.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 4 -mheight 4	

$(OBJEVENTGFXDIR)/people/speedwagon.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 4 -mheight 4	

$(OBJEVENTGFXDIR)/people/avatar.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 4 -mheight 4	

$(OBJEVENTGFXDIR)/people/bennis.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 2 -mheight 4
...
$(OBJEVENTGFXDIR)/people/kimonogirl.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 2 -mheight 4	

$(OBJEVENTGFXDIR)/people/channeler.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 2 -mheight 4	

$(OBJEVENTGFXDIR)/people/kimono_old_lady.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 2 -mheight 4

$(OBJEVENTGFXDIR)/people/staff_employee.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 2 -mheight 4

$(OBJEVENTGFXDIR)/people/staff_employee2.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 2 -mheight 4

$(OBJEVENTGFXDIR)/people/old_man_dojo.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 2 -mheight 4	

$(OBJEVENTGFXDIR)/people/kimono_woman.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 2 -mheight 4	
...
$(OBJEVENTGFXDIR)/people/professor.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 2 -mheight 4	

$(OBJEVENTGFXDIR)/people/cynthia.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 2 -mheight 4	

$(OBJEVENTGFXDIR)/people/aria.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 2 -mheight 4
...
$(OBJEVENTGFXDIR)/people/luna_male/walking.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 2 -mheight 4

$(OBJEVENTGFXDIR)/people/luna_male/running.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 2 -mheight 4

$(OBJEVENTGFXDIR)/people/luna_male/field_move.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 4 -mheight 4

$(OBJEVENTGFXDIR)/people/luna_male/surfing.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 4 -mheight 4

$(OBJEVENTGFXDIR)/people/luna_male/mach_bike.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 4 -mheight 4

$(OBJEVENTGFXDIR)/people/luna_male/acro_bike.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 4 -mheight 4

$(OBJEVENTGFXDIR)/people/luna_male/fishing.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 4 -mheight 4

$(OBJEVENTGFXDIR)/people/luna_male/watering.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 4 -mheight 4

$(OBJEVENTGFXDIR)/people/luna_male/underwater.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 4 -mheight 4


$(OBJEVENTGFXDIR)/people/luna_female/walking.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 2 -mheight 4

$(OBJEVENTGFXDIR)/people/luna_female/running.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 2 -mheight 4

$(OBJEVENTGFXDIR)/people/luna_female/field_move.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 4 -mheight 4

$(OBJEVENTGFXDIR)/people/luna_female/surfing.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 4 -mheight 4

$(OBJEVENTGFXDIR)/people/luna_female/mach_bike.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 4 -mheight 4

$(OBJEVENTGFXDIR)/people/luna_female/acro_bike.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 4 -mheight 4

$(OBJEVENTGFXDIR)/people/luna_female/fishing.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 4 -mheight 4

$(OBJEVENTGFXDIR)/people/luna_female/watering.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 4 -mheight 4

$(OBJEVENTGFXDIR)/people/luna_female/underwater.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 4 -mheight 4

$(OBJEVENTGFXDIR)/people/baldmo/walking.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 2 -mheight 4

$(OBJEVENTGFXDIR)/people/baldmo/running.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 2 -mheight 4

$(OBJEVENTGFXDIR)/people/baldmo/field_move.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 4 -mheight 4

$(OBJEVENTGFXDIR)/people/baldmo/surfing.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 4 -mheight 4

$(OBJEVENTGFXDIR)/people/baldmo/mach_bike.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 4 -mheight 4

$(OBJEVENTGFXDIR)/people/baldmo/acro_bike.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 4 -mheight 4

$(OBJEVENTGFXDIR)/people/baldmo/fishing.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 4 -mheight 4

$(OBJEVENTGFXDIR)/people/baldmo/watering.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 4 -mheight 4

$(OBJEVENTGFXDIR)/people/baldmo/underwater.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 4 -mheight 4
...
$(FLDEFFGFXDIR)/snow.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 2 -mheight 2
...
$(FLDEFFGFXDIR)/snow_bike_tire_tracks.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 2 -mheight 2
...
$(FLDEFFGFXDIR)/snow_tracks.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 2 -mheight 2
...
$(FLDEFFGFXDIR)/snow_tall_grass.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 2 -mheight 2

$(FLDEFFGFXDIR)/ultra_space_tall_grass.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 2 -mheight 2	
