...
const u8 *const gBattleStringsTable[BATTLESTRINGS_COUNT] =
{
    ...
    [STRINGID_ATTACKERBECAMEASHSPECIES]             = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} became Bald-Greninja!\p"),
    ...
    [STRINGID_ABILITYWEAKENEDSURROUNDINGMONSSTAT]   = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX}'s {B_SCR_ACTIVE_ABILITY} weakened the {B_BUFF1} of all surrounding Pokémon!"),
...
const u8 gText_BattleWhitneyName[] = _("WHITNEY");
const u8 gText_BattleDaveName[] = _("DAVE");
const u8 gText_BattleMomoName[] = _("MOMO");
const u8 gText_BattleAriaName[] = _("ARIA");
const u8 gText_BattleBennisName[] = _("BENNIS");
