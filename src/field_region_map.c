...
static void FieldUpdateRegionMap(void)
{
    ...
    switch (sFieldRegionMapHandler->state)
    {
        ...
        case 1:
            ...
            if(mapNumber == 1) {
                offset = GetStringCenterAlignXOffset(FONT_NORMAL, gText_NHoenn_Menu, 0x38);
                AddTextPrinterParameterized(WIN_TITLE, FONT_NORMAL, gText_NHoenn_Menu, offset, 1, 0, NULL);
            }
