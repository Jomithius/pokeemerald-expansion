...
static const u16 sOptionsLabelGfx_NHoenn[]    = {0x180, PALTAG_OPTIONS_DEFAULT - PALTAG_OPTIONS_START};
...
{
    [POKENAV_MENUITEM_MAP]                     = COMPOUND_STRING("Check the map of HOENN."),
    ...
    [POKENAV_MENUITEM_HOENN]                   = COMPOUND_STRING("Check the map of HOENN."),
    [POKENAV_MENUITEM_NHOENN]                  = COMPOUND_STRING("Check the map of N. HOENN.")
};
