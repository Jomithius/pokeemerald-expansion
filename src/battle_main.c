...
const struct TrainerClass gTrainerClasses[TRAINER_CLASS_COUNT] =
{
    ...
    [TRAINER_CLASS_HIKER] = { _("HIKER"), 15 },
    [TRAINER_CLASS_TEAM_AQUA] = { _("TEAM AQUA") },
    [TRAINER_CLASS_PKMN_BREEDER] = { _("{PKMN} BREEDER"), 15, B_TRAINER_CLASS_POKE_BALLS >= GEN_8 ? BALL_HEAL : BALL_FRIEND },
    [TRAINER_CLASS_COOLTRAINER] = { _("COOLTRAINER"), 20, BALL_ULTRA },
    ...
    [TRAINER_CLASS_AROMA_LADY] = { _("AROMA LADY"), 12 },
    [TRAINER_CLASS_RUIN_MANIAC] = { _("RUIN MANIAC"), 15 },
    [TRAINER_CLASS_INTERVIEWER] = { _("INTERVIEWER"), 12 },
    [TRAINER_CLASS_TUBER_F] = { _("TUBER"), 5 },
    [TRAINER_CLASS_TUBER_M] = { _("TUBER"), 5 },
    ...
    [TRAINER_CLASS_CAMPER] = { _("CAMPER"), 8 },
    [TRAINER_CLASS_PICNICKER] = { _("PICNICKER"), 8 },
    ...
    [TRAINER_CLASS_YOUNGSTER] = { _("YOUNGSTER"), 5 },
    ...
    [TRAINER_CLASS_KIMONO_WOMAN] = { _("KIMONO WOMAN"), 40, BALL_FRIEND },
    [TRAINER_CLASS_KIMONO_LADY] = { _("KIMONO LADY"), 30, BALL_LOVE },
    [TRAINER_CLASS_CHIEF] = { _("CHIEF"), 40 },
    [TRAINER_CLASS_NIGHTMARE] = { _("NIGHTMARE"), 5, BALL_DUSK },
        ...
        case STATE_WAIT_ACTION_CHOSEN: // Try to perform an action.
            if (!(gBattleControllerExecFlags & (((1u << battler)) | (0xF << 28) | ((1u << battler) << 4) | ((1u << battler) << 8) | ((1u << battler) << 12))))
            {
                ...
                case B_ACTION_USE_ITEM:
                    ...
                    if (FlagGet(FLAG_SYS_HARD_MODE) && gBattleTypeFlags & (BATTLE_TYPE_LINK
