...
static const u8 sTileBitAttributes[NUM_METATILE_BEHAVIORS] =
{
    ...
    [MB_ULTRA_SPACE_TALL_GRASS]             = TILE_FLAG_UNUSED | TILE_FLAG_HAS_ENCOUNTERS,
    [MB_SNOW_TALL_GRASS]                    = TILE_FLAG_UNUSED | TILE_FLAG_HAS_ENCOUNTERS,
...
{
    if (metatileBehavior == MB_TALL_GRASS || metatileBehavior == MB_LONG_GRASS || metatileBehavior == MB_SNOW_TALL_GRASS || metatileBehavior == MB_ULTRA_SPACE_TALL_GRASS)
        return TRUE;
    else
        return FALSE;
}
...
bool8 MetatileBehavior_IsUltraSpaceTallGrass(u8 metatileBehavior)
{
    if (metatileBehavior == MB_ULTRA_SPACE_TALL_GRASS)
        return TRUE;
    else
        return FALSE;
}
...
bool8 MetatileBehavior_IsRegionMapNHoenn(u8 metatileBehavior)
{
    if (metatileBehavior == MB_REGION_MAP_NHOENN)
        return TRUE;
    else
        return FALSE;
}
...
bool8 MetatileBehavior_IsCuttableGrass(u8 metatileBehavior)
{
    if (metatileBehavior == MB_TALL_GRASS
     ...
     || metatileBehavior == MB_SNOWGRASS
     || metatileBehavior == MB_SNOW_TALL_GRASS
     || metatileBehavior == MB_ULTRA_SPACE_TALL_GRASS
