static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_THE_UNDER - 1] = {MAP_GROUP(THE_UNDER), MAP_NUM(THE_UNDER), 29, 47},
    [HEAL_LOCATION_ROUTE135 - 1] = {MAP_GROUP(ROUTE135), MAP_NUM(ROUTE135), 8, 10},
    [HEAL_LOCATION_WACHUNPELON_CITY - 1] = {MAP_GROUP(WACHUNPELON_CITY), MAP_NUM(WACHUNPELON_CITY), 16, 19},
    [HEAL_LOCATION_ULTRA_SPACE - 1] = {MAP_GROUP(ULTRA_SPACE), MAP_NUM(ULTRA_SPACE), 26, 49},
    [HEAL_LOCATION_NEW_MOON_ISLAND - 1] = {MAP_GROUP(NEW_MOON_ISLAND), MAP_NUM(NEW_MOON_ISLAND), 8, 23},
    [HEAL_LOCATION_BALDESIA - 1] = {MAP_GROUP(BALDESIA), MAP_NUM(BALDESIA), 23, 22},
    [HEAL_LOCATION_SNOWDRIFT_CITY - 1] = {MAP_GROUP(SNOWDRIFT_CITY), MAP_NUM(SNOWDRIFT_CITY), 27, 13},
    [HEAL_LOCATION_VOID - 1] = {MAP_GROUP(VOID), MAP_NUM(VOID), 9, 32},
    [HEAL_LOCATION_AREA_ZERO - 1] = {MAP_GROUP(AREA_ZERO), MAP_NUM(AREA_ZERO), 15, 11},
};
