const u8 gFacilityClassToPicIndex[] =
{
    ...
    [FACILITY_CLASS_JOMITHIUS] = TRAINER_PIC_EMO,
    [FACILITY_CLASS_JAMES] = TRAINER_PIC_JAMES,
    [FACILITY_CLASS_LUNA] = TRAINER_PIC_LUNA,
    [FACILITY_CLASS_LUNA_MALE] = TRAINER_PIC_LUNA_MALE,
    [FACILITY_CLASS_LUNA_FEMALE] = TRAINER_PIC_LUNA_FEMALE,
    [FACILITY_CLASS_BALDMO] = TRAINER_PIC_BALDMO,
};
