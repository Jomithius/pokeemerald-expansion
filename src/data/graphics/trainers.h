...
const u32 gTrainerFrontPic_Ratduardo[] = INCBIN_U32("graphics/trainers/front_pics/ratduardo.4bpp.lz");
const u32 gTrainerPalette_Ratduardo[] = INCBIN_U32("graphics/trainers/palettes/ratduardo.gbapal.lz");

const u32 gTrainerFrontPic_Bennis[] = INCBIN_U32("graphics/trainers/front_pics/bennis.4bpp.lz");
const u32 gTrainerPalette_Bennis[] = INCBIN_U32("graphics/trainers/palettes/bennis.gbapal.lz");

const u32 gTrainerFrontPic_Emo[] = INCBIN_U32("graphics/trainers/front_pics/emo.4bpp.lz");
...
const u32 gTrainerFrontPic_Momo[] = INCBIN_U32("graphics/trainers/front_pics/momo.4bpp.lz");
const u32 gTrainerPalette_Momo[] = INCBIN_U32("graphics/trainers/palettes/momo.gbapal.lz");

const u32 gTrainerFrontPic_Misa[] = INCBIN_U32("graphics/trainers/front_pics/misa.4bpp.lz");
const u32 gTrainerPalette_Misa[] = INCBIN_U32("graphics/trainers/palettes/misa.gbapal.lz");

const u32 gTrainerFrontPic_Luna[] = INCBIN_U32("graphics/trainers/front_pics/luna.4bpp.lz");
const u32 gTrainerPalette_Luna[] = INCBIN_U32("graphics/trainers/palettes/luna.gbapal.lz");
...
const u32 gTrainerFrontPic_Ninja[] = INCBIN_U32("graphics/trainers/front_pics/ninja.4bpp.lz");
const u32 gTrainerPalette_Ninja[] = INCBIN_U32("graphics/trainers/palettes/ninja.gbapal.lz");
...
const u32 gTrainerFrontPic_BlackBeltFr[] = INCBIN_U32("graphics/trainers/front_pics/black_belt_fr.4bpp.lz");
const u32 gTrainerPalette_BlackBeltFr[] = INCBIN_U32("graphics/trainers/palettes/black_belt_fr.gbapal.lz");

const u32 gTrainerFrontPic_NightmareRatduardo[] = INCBIN_U32("graphics/trainers/front_pics/nightmare_ratduardo.4bpp.lz");
const u32 gTrainerFrontPic_Nightmare[] = INCBIN_U32("graphics/trainers/front_pics/nightmare.4bpp.lz");
const u32 gTrainerPalette_Nightmare[] = INCBIN_U32("graphics/trainers/palettes/nightmare.gbapal.lz");
...
const u32 gTrainerFrontPic_LunaMale[] = INCBIN_U32("graphics/trainers/front_pics/luna_male.4bpp.lz");
const u32 gTrainerPalette_LunaMale[] = INCBIN_U32("graphics/trainers/palettes/luna_male.gbapal.lz");

const u32 gTrainerFrontPic_LunaFemale[] = INCBIN_U32("graphics/trainers/front_pics/luna_female.4bpp.lz");
const u32 gTrainerPalette_LunaFemale[] = INCBIN_U32("graphics/trainers/palettes/luna_female.gbapal.lz");

const u32 gTrainerFrontPic_Baldmo[] = INCBIN_U32("graphics/trainers/front_pics/baldmo.4bpp.lz");
const u32 gTrainerPalette_Baldmo[] = INCBIN_U32("graphics/trainers/palettes/baldmo.gbapal.lz");
...
const u8 gTrainerBackPic_Momo[] = INCBIN_U8("graphics/trainers/back_pics/momo.4bpp");
const u8 gTrainerBackPic_LunaMale[] = INCBIN_U8("graphics/trainers/back_pics/luna_male.4bpp");
const u8 gTrainerBackPic_LunaFemale[] = INCBIN_U8("graphics/trainers/back_pics/luna_female.4bpp");
const u8 gTrainerBackPic_Baldmo[] = INCBIN_U8("graphics/trainers/back_pics/baldmo.4bpp");
...
const struct TrainerSprite gTrainerSprites[] =
{
    ...
    TRAINER_SPRITE(TRAINER_PIC_ELITE_FOUR_GLACIA, gTrainerFrontPic_EliteFourGlacia, gTrainerPalette_EliteFourGlacia),
    TRAINER_SPRITE(TRAINER_PIC_ELITE_FOUR_DRAKE, gTrainerFrontPic_EliteFourDrake, gTrainerPalette_EliteFourDrake, 0, 7, 0x188),
    ...
    TRAINER_SPRITE(TRAINER_PIC_CHAMPION_WALLACE, gTrainerFrontPic_ChampionWallace, gTrainerPalette_ChampionWallace),
    ...
    TRAINER_SPRITE(TRAINER_PIC_NINJA, gTrainerFrontPic_Ninja, gTrainerPalette_Ninja),
    TRAINER_SPRITE(TRAINER_PIC_BRUNO, gTrainerFrontPic_Bruno, gTrainerPalette_Bruno),
    TRAINER_SPRITE(TRAINER_PIC_BLACK_BELT_FR, gTrainerFrontPic_BlackBeltFr, gTrainerPalette_BlackBeltFr),
    ...
    TRAINER_SPRITE(TRAINER_PIC_BALDMO, gTrainerFrontPic_Baldmo, gTrainerPalette_Baldmo),
};
...
const struct SpriteFrameImage gTrainerBackPicTable_Momo[] =
{
    {gTrainerBackPic_Momo + TRAINER_PIC_SIZE * 0, TRAINER_PIC_SIZE},
    {gTrainerBackPic_Momo + TRAINER_PIC_SIZE * 1, TRAINER_PIC_SIZE},
    {gTrainerBackPic_Momo + TRAINER_PIC_SIZE * 2, TRAINER_PIC_SIZE},
    {gTrainerBackPic_Momo + TRAINER_PIC_SIZE * 3, TRAINER_PIC_SIZE},
    {gTrainerBackPic_Momo + TRAINER_PIC_SIZE * 4, TRAINER_PIC_SIZE},
};
...
const struct SpriteFrameImage gTrainerBackPicTable_Baldmo[] =
{
    {gTrainerBackPic_Baldmo + TRAINER_PIC_SIZE * 0, TRAINER_PIC_SIZE},
    {gTrainerBackPic_Baldmo + TRAINER_PIC_SIZE * 1, TRAINER_PIC_SIZE},
    {gTrainerBackPic_Baldmo + TRAINER_PIC_SIZE * 2, TRAINER_PIC_SIZE},
    {gTrainerBackPic_Baldmo + TRAINER_PIC_SIZE * 3, TRAINER_PIC_SIZE},
    {gTrainerBackPic_Baldmo + TRAINER_PIC_SIZE * 4, TRAINER_PIC_SIZE},
};
...
{
    TRAINER_BACK_SPRITE(TRAINER_BACK_PIC_BRENDAN, 5, gTrainerBackPic_LunaMale, gTrainerBackPicTable_LunaMale, gTrainerBackPicPalette_LunaMale, sBackAnims_Kanto),
    TRAINER_BACK_SPRITE(TRAINER_BACK_PIC_MAY, 5, gTrainerBackPic_LunaFemale, gTrainerBackPicTable_LunaFemale, gTrainerBackPicPalette_LunaFemale, sBackAnims_Kanto),
    ...
    TRAINER_BACK_SPRITE(TRAINER_BACK_PIC_BALDMO, 5, gTrainerBackPic_Baldmo, gTrainerBackPicTable_Baldmo, gTrainerPalette_Baldmo, sBackAnims_Kanto),
};
