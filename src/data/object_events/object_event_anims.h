...
static const union AnimCmd sAnim_FaceEast_AsymNPC[] =
{
    ANIMCMD_FRAME(9, 16),
    ANIMCMD_JUMP(0),
};
...
static const union AnimCmd sAnim_GoEast_AsymNPC[] =
{
    ANIMCMD_FRAME(10, 8),
    ANIMCMD_FRAME(9, 8),
    ANIMCMD_FRAME(11, 8),
...
static const union AnimCmd sAnim_GoFastEast_AsymNPC[] =
{
    ANIMCMD_FRAME(10, 4),
    ANIMCMD_FRAME(9, 4),
    ANIMCMD_FRAME(11, 4),
...
static const union AnimCmd sAnim_StepBackEast[] =
{
    ANIMCMD_FRAME(8, 4),
    ANIMCMD_FRAME(2, 4),
    ANIMCMD_FRAME(7, 4),
...
static const union AnimCmd sAnim_StepBackWest[] =
{
    ANIMCMD_FRAME(8, 4, .hFlip = TRUE),
    ANIMCMD_FRAME(2, 4, .hFlip = TRUE),
    ANIMCMD_FRAME(7, 4, .hFlip = TRUE),
...
static const union AnimCmd sAnim_AvatarFloat[] =
{
    ANIMCMD_FRAME(1, 8),
    ANIMCMD_FRAME(0, 8),
    ANIMCMD_FRAME(1, 8),
...
static const union AnimCmd sAnim_AvatarFloatNorth[] =
{
    ANIMCMD_FRAME(3, 8),
    ANIMCMD_FRAME(2, 8),
    ANIMCMD_FRAME(3, 8),
...
static const union AnimCmd *const sAnimTable_Avatar[] = {
    [ANIM_STD_FACE_SOUTH] = sAnim_FaceSouth,
    [ANIM_STD_FACE_NORTH] = sAnim_FaceNorth2F,
    [ANIM_STD_FACE_WEST] = sAnim_FaceSouth,
    [ANIM_STD_FACE_EAST] = sAnim_FaceSouth,
    [ANIM_STD_GO_SOUTH] = sAnim_AvatarFloat,
    [ANIM_STD_GO_NORTH] = sAnim_AvatarFloatNorth,
    [ANIM_STD_GO_WEST] = sAnim_AvatarFloat,
    [ANIM_STD_GO_EAST] = sAnim_AvatarFloat,
    [ANIM_STD_GO_FAST_SOUTH] = sAnim_GoFastSouth,
    [ANIM_STD_GO_FAST_NORTH] = sAnim_GoFastNorth,
    [ANIM_STD_GO_FAST_WEST] = sAnim_GoFastWest,
    [ANIM_STD_GO_FAST_EAST] = sAnim_GoFastEast,
...
static const union AnimCmd *const sAnimTable_AsymNPC[] = {
    [ANIM_STD_FACE_SOUTH] = sAnim_FaceSouth,
    [ANIM_STD_FACE_NORTH] = sAnim_FaceNorth,
    [ANIM_STD_FACE_WEST] = sAnim_FaceWest,
    [ANIM_STD_FACE_EAST] = sAnim_FaceEast_AsymNPC,
    [ANIM_STD_GO_SOUTH] = sAnim_GoSouth,
    [ANIM_STD_GO_NORTH] = sAnim_GoNorth,
    [ANIM_STD_GO_WEST] = sAnim_GoWest,
    [ANIM_STD_GO_EAST] = sAnim_GoEast_AsymNPC,
    [ANIM_STD_GO_FAST_SOUTH] = sAnim_GoFastSouth,
    [ANIM_STD_GO_FAST_NORTH] = sAnim_GoFastNorth,
    [ANIM_STD_GO_FAST_WEST] = sAnim_GoFastWest,
    [ANIM_STD_GO_FAST_EAST] = sAnim_GoFastEast_AsymNPC,
    [ANIM_STD_GO_FASTER_SOUTH] = sAnim_GoFasterSouth,
    [ANIM_STD_GO_FASTER_NORTH] = sAnim_GoFasterNorth,
    [ANIM_STD_GO_FASTER_WEST] = sAnim_GoFasterWest,
    [ANIM_STD_GO_FASTER_EAST] = sAnim_GoFasterEast,
    [ANIM_STD_GO_FASTEST_SOUTH] = sAnim_GoFastestSouth,
    [ANIM_STD_GO_FASTEST_NORTH] = sAnim_GoFastestNorth,
    [ANIM_STD_GO_FASTEST_WEST] = sAnim_StepBackWest,
