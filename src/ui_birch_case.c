...
static const struct MonChoiceData sStarterChoices[9] = 
{
    ...
    [BALL_TOP_THIRD]        = {SPECIES_GROOKEY, 5, ITEM_ORAN_BERRY, BALL_POKE},
    [BALL_TOP_FOURTH]       = {SPECIES_SOBBLE, 5, ITEM_ORAN_BERRY, BALL_POKE},
    [BALL_MIDDLE_THIRD]     = {SPECIES_SCORBUNNY, 5, ITEM_ORAN_BERRY, BALL_POKE},
