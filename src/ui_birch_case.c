...
{
    [BALL_TOP_FIRST]        = {SPECIES_TREECKO, 5, ITEM_ORAN_BERRY, BALL_POKE},
    [BALL_TOP_SECOND]       = {SPECIES_MUDKIP, 5, ITEM_ORAN_BERRY, BALL_POKE},
    [BALL_MIDDLE_FIRST]     = {SPECIES_TORCHIC, 5, ITEM_ORAN_BERRY, BALL_POKE},

    [BALL_TOP_THIRD]        = {SPECIES_CHIKORITA, 5, ITEM_ORAN_BERRY, BALL_POKE},
    [BALL_TOP_FOURTH]       = {SPECIES_TOTODILE, 5, ITEM_ORAN_BERRY, BALL_POKE},
    [BALL_MIDDLE_THIRD]     = {SPECIES_CYNDAQUIL, 5, ITEM_ORAN_BERRY, BALL_POKE},

    [BALL_MIDDLE_SECOND]    = {SPECIES_CHARMANDER, 5, ITEM_ORAN_BERRY, BALL_POKE},
    [BALL_BOTTOM_FIRST]     = {SPECIES_BULBASAUR, 5, ITEM_ORAN_BERRY, BALL_POKE},
    [BALL_BOTTOM_SECOND]    = {SPECIES_SQUIRTLE, 5, ITEM_ORAN_BERRY, BALL_POKE},
};
...
static void CB2_BirchStartFirstBattle(void);
static void CB2_BirchEndFirstBattle(void);
...
static void Task_BirchCaseTurnOff(u8 taskId)
{
    if (!gPaletteFade.active)
    {
        ...
        ResetTasks();
        PlayBattleBGM();
        SetMainCallback2(CB2_BirchStartFirstBattle);
...
static const u8 sText_RecievedMon[] = _("Are you sure?");
static void PrintTextToBottomBar(u8 textId)
{
...
static void CB2_BirchStartFirstBattle(void)
{
    ...
    if (IsBattleTransitionDone() == TRUE)
    {
        ...
        gMain.savedCallback = CB2_BirchEndFirstBattle;
        FreeAllWindowBuffers();
...
static void CB2_BirchEndFirstBattle(void) /* Had DowngradeBadPoison(); after Overworld_ClearSavedMusic();
    shouldn't be needed tho since this is just for the Zigzagoon battle. */
{
