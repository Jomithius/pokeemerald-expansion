...
static const u8 sRegionMapSectionId_To_PopUpThemeIdMapping[] =
{
    ...
    [MAPSEC_RAT_CAVE - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_STONE,
    [MAPSEC_THE_UNDER - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_STONE2,
    [MAPSEC_ROUTE_135 - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ROUTE_136 - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_WACHUNPELON - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_ROUTE_137 - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_UNDERWATER,
    [MAPSEC_ULTRA_SPACE - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_STONE,
    [MAPSEC_NEWMOON_ISLAND - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_STONE2,
    [MAPSEC_FULLMOON_ISLAND - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_STONE,
    [MAPSEC_BEACHSIDE_CAVE - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_UNDERWATER,
    [MAPSEC_FLOWER_PARADISE - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_THE_VOID - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_STONE,
    [MAPSEC_ROUTE_138 - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_BALDESIA - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ROUTE_139 - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_EASTERN_RUINS - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_STONE2,
    [MAPSEC_BALDESIAN_ALTAR - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_AZURE_MOUNTAIN - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_STONE2,
    [MAPSEC_SNOWDRIFT_CITY - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_BALDESIAN_FOREST - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_AZURE_CHASM - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_STONE,
};
