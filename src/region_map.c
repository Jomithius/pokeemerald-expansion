...
static u8 GetMapsecType(u16 mapSecId)
{
    ...
    case MAPSEC_THE_UNDER:
        return FlagGet(FLAG_VISITED_THE_UNDER) ? MAPSECTYPE_ROUTE_CANFLY : MAPSECTYPE_ROUTE;
    case MAPSEC_ROUTE_135:
        return FlagGet(FLAG_VISITED_ROUTE135) ? MAPSECTYPE_ROUTE_CANFLY : MAPSECTYPE_ROUTE;
    case MAPSEC_WACHUNPELON:
        return FlagGet(FLAG_VISITED_WACHUNPELON) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_BALDESIA:
        return FlagGet(FLAG_VISITED_BALDESIA) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_SNOWDRIFT_CITY:
        return FlagGet(FLAG_VISITED_SNOWDRIFT_CITY) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    default:
