...
const u8 gText_Wallace[] = _("JIMMY");
const u8 gText_Steven[] = _("STEVEN");
const u8 gText_Brawly[] = _("LIAM");
const u8 gText_Winona[] = _("MICKEY");
const u8 gText_Phoebe[] = _("LINA");
const u8 gText_Glacia[] = _("XION");
...
const u8 gText_MenuModeSwitch[] = _("MODE");
...
const u8 gText_UltraSpace[] = _("ULTRA SPACE");
const u8 gText_AreaZero[] = _("AREA ZERO");
const u8 gText_ICameToGetYou[] = _("I came to get you.");
const u8 gText_AreYouOkay[] = _("Are you okay?");
const u8 gText_DontLetHim[] = _("Don't let him get to you.");
